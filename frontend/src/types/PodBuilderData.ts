...
export const mockPods: PodBuildData[] = [
  { name: "Racer-1", engineCount: 2, color: "#000000", armorRating: 1 },
  { name: "Thunderbolt", engineCount: 3, color: "#FF4500", armorRating: 2 },
  ...
  { name: "Crimson Comet", engineCount: 3, color: "#DC143C", armorRating: 2 },
  ...
  { name: "Vortex", engineCount: 3, color: "#00CED1", armorRating: 2 },
];
